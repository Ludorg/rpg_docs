...
Une fois la cour explorée, les explorateurs néophytes ont poursuivi les investigations dans le batiment calciné.  Ils y ont découvert les ruine d'un inquiétant charnier et fontaine d'où sortait un étrange liquide goudronneux.
...
Les futurs héros sont alors retournés à Srathford pour un peu de repos.
